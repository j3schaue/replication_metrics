...
\hline\hline
\end{tabular}
\caption{Probability of rejecting a true null hypothesis for the \textit{t} test and McNemar's test. Standard errors are reported in  parentheses and rounded to the first significant digit.}
\end{table}
...
>>>>>>> 796555b595c5e5de3516f9efbf8d6204c04cdeaa
