...
For programs such as that of the OSC, this involves $\theta_1$ for the original study and $\theta_2$ for the replicate.
...
That is, findings were deemed to have replicated if both studies found significant effects in the same direction---i.e., both positive---or if both studies found null effects.
